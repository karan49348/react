...
import Assiment1 from './Assiment1'
import Emai from './Emai'
import Login from './Login'
import Pasword from './Pasword'
import Signup from './Signup'
import Newfirst from './Newfirst'
...
const data = {
  ...
  users: [
    ...
    },
    {
      ...
      age: 41,
      gender: "male",
      email: "daniel.thomas@x.dummyjson.com",
    ...
    },
    {
      ...
      age: 27,
      gender: "female",
      email: "mia.moore@x.dummyjson.com",
    ...
    },
    {
      ...
      age: 38,
      gender: "male",
      email: "william.jackson@x.dummyjson.com",
      image: "https://dummyjson.com/icon/williamj/128",
      role: "user"
    },
    {
      id: 14,
      ...
      age: 30,
      gender: "female",
      email: "charlotte.white@x.dummyjson.com",
      image: "https://dummyjson.com/icon/charlottew/128",
      role: "user"
    },
    {
      id: 15,
      ...
      image: "https://dummyjson.com/icon/benjaminh/128",
      role: "user"
    },
    {
      id: 16,
      ...
      age: 26,
      gender: "female",
      email: "amelia.martin@x.dummyjson.com",
      image: "https://dummyjson.com/icon/ameliab/128",
      role: "user"
    },
    {
      id: 17,
      ...
      age: 37,
      gender: "male",
      email: "lucas.thompson@x.dummyjson.com",
    ...
    },
    {
      ...
      image: "https://dummyjson.com/icon/harperg/128",
      role: "user"
    },
    {
      id: 19,
      ...
      age: 42,
      gender: "male",
      email: "henry.martinez@x.dummyjson.com",
      image: "https://dummyjson.com/icon/henrym/128",
      role: "user"
    },
    {
      id: 20,
      ...
      age: 33,
      gender: "female",
      email: "evelyn.robinson@x.dummyjson.com",
      image: "https://dummyjson.com/icon/evelynr/128",
      role: "user"
    }
  ]
};
  ...
  return (
    ...
    <Routes>
     ...
     <Route path="/about" element={<About />} />
      ...
      <Route path="/Assiment1" element={<Assiment1 />} />
      <Route path="/Pasword" element={<Pasword />} />
      <Route path="/Login" element={<Login  />} />
      <Route path="/Emai" element={<Emai />} />
      <Route path="/newfirst" element={<Newfirst  data={data}/>} />
       <Route path="/newtwo" element={<Newtwo  usersData={ usersData}/>} />

      <Route path="/Pre" element={<Pre  update={update}/>} />
    </Routes>
    </BrowserRouter>
  )
}
